...
#         print(f"❌ Error generating mindmap for {"home"}: {e}")
#         return None
...
async def replace_ampersand_with_space(input_file, output_file=None):
    """
    Replace '&' with a space in all node TEXT attributes inside a FreeMind (.mm) file,
    even if the XML has unescaped ampersands.
    """
...
async def home_page(
    ...
    await replace_ampersand_with_space(out_file,out_file)
    print("🎯 Done.")
