  ...
  <node TEXT="Home">
    <node TEXT="Header">
      <node TEXT="Navigation">
        <node TEXT="Home">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/" />
        </node>
        <node TEXT="Search">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/340b-search" />
          ...
          <node TEXT="COMMENTS">
            ...
            <node TEXT="Torey Lam">
              <node TEXT="CVS pharmacy needs to enter the 340B coupon codes by first searching the TPPC code, not the BIN code. I'm noticing that CVS pharmacies are searching the 340B discount code by first searching the &quot;BIN&quot; number, which lists way too many options. If CVS pharmacy searches FIRST by the TPPC they can then find the right BIN and PCN codes. Once they enter it in the system, the 340B price will show.">
                </node>
              <node TEXT="Reply">
                <node TEXT="https://www.340bpriceguide.net/340b-search">
                    </node>
            ...
            <node TEXT="Torey Lam">
              <node TEXT="Hi Tammy, the mobile app has been available for several months. You can download from the Apple Store or Google Play. Here is a video on how to use the mobile app: https://www.340bpriceguide.net/articles-news/132-mobile-app-how-to-use">
                </node>
              <node TEXT="Reply">
                <node TEXT="https://www.340bpriceguide.net/340b-search">
                    </node>
            ...
            <node TEXT="Steven Busselen">
              <node TEXT="I've noticed that a 1-year supply is often not much more expensive that a 90-day supply. However, CVS 222 W. Carrillo has been dispensing 90-day supplies of Synjardy XR 12.5/1000 when I order 730 tablets. Is CVS messing this up or am I?">
                </node>
              <node TEXT="Reply">
                <node TEXT="https://www.340bpriceguide.net/340b-search">
                    </node>
            ...
            <node TEXT="Sarah Munoz">
              <node TEXT="Is Levemir FlexPen 100unit/mL still covered? I only see Levemir in the vial">
                </node>
              <node TEXT="Reply">
                <node TEXT="https://www.340bpriceguide.net/340b-search">
                    </node>
            ...
            <node TEXT="Kirk J.">
              <node TEXT="On the 340b Price Guide is the unit cost $0.04 the cost per pill? So if the Rx was for 100 tablets x 0.04, it would be $4.00?">
                </node>
              <node TEXT="Reply">
                <node TEXT="https://www.340bpriceguide.net/340b-search">
                    </node>
            ...
            <node TEXT="Torey Lam">
              <node TEXT="On the far left, remember to select the pharmacy, quantity, and patient group. Once you've selected all, you can see the total estimated amount the patient will pay at the pharmacy.">
                </node>
              <node TEXT="Reply">
                <node TEXT="https://www.340bpriceguide.net/340b-search">
                    </node>
            ...
            <node TEXT="Torey Lam">
              <node TEXT="Hi Stacy, On the far left, where you search for medications, there is a drop-down option, &quot;Choose Formulary.&quot; If your clinic has a 340B formulary, you can select medications directly from there.">
                </node>
              <node TEXT="Reply">
                <node TEXT="https://www.340bpriceguide.net/340b-search">
                    </node>
            ...
            <node TEXT="Kim Kelly">
              <node TEXT="I am seeing Farxiga and symbicort as available at Genoa on 340B but the Genoa pharmacists say they are not available. Am I using the website incorrectly?">
                </node>
              <node TEXT="Reply">
                <node TEXT="https://www.340bpriceguide.net/340b-search">
                    </node>
            ...
            <node TEXT="Torey Lam">
              <node TEXT="Hi Kim, I'll contact your 340B program manager to see what is going on here. There might be a data issue with the TPA or wholesaler setup and I will get back with you.">
                </node>
              <node TEXT="Reply">
                <node TEXT="https://www.340bpriceguide.net/340b-search">
                    </node>
            ...
            <node TEXT="Torey Lam">
              <node TEXT="Unfortunately, it is not. Please try searching for DICLOFENAC 1.5% TOPICAL SOLN. Consider asking the pharmacy if they have in stock. It appears this item frequently runs low on supply">
                </node>
              <node TEXT="Reply">
                <node TEXT="https://www.340bpriceguide.net/340b-search">
                    </node>
            ...
            <node TEXT="Torey Lam">
              <node TEXT="Levemir has been removed from 340B Price Guide since Novo Nordisk will discontinue it. Please see the article: https://www.340bpriceguide.net/articles-news/118-novo-nordisk-will-discontinue-levemir">
                </node>
              <node TEXT="Reply">
                <node TEXT="https://www.340bpriceguide.net/340b-search">
                    </node>
        ...
        <node TEXT="Articles">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/articles-news" />
          ...
          <node TEXT="Bausch Health Exits the 340B Drug Pricing Program">
            <node TEXT="Effective October 1, 2025, Bausch Health has ended its participation in the 340B Drug Pricing Program. As a result, Bausch products are no longer considered covered outpatient drugs and are not eligible for 340B pricing." />
            <node TEXT="Read more ...">
        ...
        <node TEXT="About">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/about-us" />
          <node TEXT="340B Price Guide">
            <node TEXT="Customized publication for eligible health organizations, helps interpret drug prices and their impact on patient care." />
          </node>
          <node TEXT="340B Guided Services">
            <node TEXT="Independent consulting for covered entities, ensuring best practices and better health outcomes." />
          </node>
          <node TEXT="Client Testimonials">
            <node TEXT="Northwest Human Services">
              <node TEXT="340B Price Guide is excellent, saves time, helps patients afford meds, and is easy to navigate." />
            </node>
            <node TEXT="Beaufort Memorial Hospital">
              <node TEXT="340B Price Guide is excellent and helpful for communicating the 340B program to staff and physicians." />
            </node>
            <node TEXT="One Community Health">
              <node TEXT="340B Price Guide helped solve a dilemma with GoodRx and Walmart pricing." />
            </node>
            <node TEXT="CHC Lane County">
              <node TEXT="340B pricing helped a patient save money on Januvia." />
            </node>
          </node>
          <node TEXT="www.hrsa.gov/opa">
            <node TEXT="www.hrsa.gov/opa" />
          </node>
        </node>
        <node TEXT="Contact">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/contact-us" />
          ...
          <node TEXT="info@340Bpriceguide.net">
            <node TEXT="mailto:info@340Bpriceguide.com" />
          </node>
        </node>
        <node TEXT="Profile">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/my-profile" />
          <node TEXT="ALI ZAIN">
          ...
          <node TEXT="DETAILS">
            ...
            <node TEXT="Email Address: alizainsharif48@gmail.com">
        ...
        <node TEXT="Logout">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/logout" />
        </node>
        <node TEXT="SecureMsg">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/secure-message" />
          ...
          <node TEXT="TOP">
            <node TEXT="TOP" LINK="https://www.340bpriceguide.net/secure-message" />
          </node>
        </node>
      </node>
    </node>
    ...
    <node TEXT="Footer">
      <node TEXT="Useful Links">
        <node TEXT="Home">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/index.php" />
        </node>
        <node TEXT="About Us">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/index.php/about-us" />
        </node>
        <node TEXT="Articles &amp; News">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/index.php/articles-news" />
        </node>
        <node TEXT="Contact Us">
          <attribute NAME="link" VALUE="https://www.340bpriceguide.net/index.php/contact-us" />
        </node>
      </node>
      <node TEXT="Information">
        <node TEXT="Linkedin">
          <attribute NAME="link" VALUE="https://www.linkedin.com/in/torey-c-lam-387a162a" />
        </node>
      </node>
      <node TEXT="Contact Us">
        ...
        <node TEXT="Email">
          <attribute NAME="link" VALUE="mailto:info@340Bpriceguide.com" />
        </node>
      </node>
      <node TEXT="www.hrsa.gov/opa">
        <attribute NAME="link" VALUE="http://www.hrsa.gov/opa" />
      </node>
    </node>
  </node>
</map>